...
Na Mongo Express bolo vytvorené smerovacie pravidlo, aplikácia je prístupná na adrese [https://wac-hospital.westeurope.cloudapp.azure.com/fea/mongo-express/](https://wac-hospital.westeurope.cloudapp.azure.com/fea/mongo-express/).
Keďže ide o verejne prístupný zdroj, prístup je chránený menom a heslom, ktoré sa dozviete od cvičiaceho.

1. Overte, či stále funguje vaša klient aplikácia (webkomponent) na adrese [https://wac-hospital.westeurope.cloudapp.azure.com/fea](https://wac-hospital.westeurope.cloudapp.azure.com/fea/).
...
7. Môžete skúsiť pristúpiť na váš web komponent cez stránku [https://wac-hospital.westeurope.cloudapp.azure.com/fea/](https://wac-hospital.westeurope.cloudapp.azure.com/fea/).
