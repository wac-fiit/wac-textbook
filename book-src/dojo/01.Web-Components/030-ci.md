...
* `actions/checkout@v4`, ktorý získa aktuálny stav nášho repozitára;
* `actions/setup-node@v4`, ktorý nainštaluje, resp. pripraví prostredie pre použitie určenej verzie Node.js;
